...
ENV_ALLOWLIST='^(SUPABASE_URL|SUPABASE_SERVICE_ROLE_KEY|SUPABASE_ANON_KEY|SUPABASE_STORAGE_BUCKET|MAX_UPLOAD_MB|KEYFRAME_INTERVAL_SECONDS|KEYFRAME_MAX_FRAMES|GRACE_RING_MM|TOLERANCE_MM|MARKER_SIDE_MM|ARUCO_DICT|GCODE_DIALECT|RUN_KEYFRAME_WORKER|CLAIM_TIMEOUT_S|MAX_ATTEMPTS|RECONSTRUCT_TIMEOUT_S|MEASURE_TIMEOUT_S|CORS_ORIGINS)='
